...
## Partitioning
Partitioning refers to the distribution of certain resources, e.g macro- and micro nutrients, between the plant organs (these comprise plant roots, leaves, stems and the plants storage organs). This distribution is highly dependent with the plants development stage (*DVS*) which differs uniquely depending on the crop species. If a resource is highly accessible and not taken up completely by the plant organs, the resource can be reserved and later be relocated again.
...
```{r, echo=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Visualisation for the partitioning simulation_</span>"}
...
\
\
```{r, echo=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>Table 1__ _Results table for the partitioning simulation_</span>"}
...
```{r, echo=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Comparison of different crop simulated with the wheat model_</span>"}
...
```{r, echo=FALSE, message=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Comparison of fractions under drought stress_</span>"}
...
```{r, echo=FALSE, message=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Difference of fractions from normal to stressed conditions_</span>"}
df1 <- read.csv2("results/R_partitioning_TRANRF_wheat.csv")
df2 <- read.csv2("results/R_partitioning_wheat.csv")
...
```{r, echo=FALSE, message=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Alteration of Root to shoot ratio under drought_</span>"}
...
```{r, echo=FALSE, message=FALSE, fig.align="center", fig.cap="<span style='color: grey;'>__Figure 1__ _Harvest Index comparison_</span>"}
df_st<- data.frame(
  cat= (c("BM","GM","BM","GM")),

...
partitioning_table <- partitioning_table[,-1]
datatable(
  partitioning_table,
  filter = 'top',
...
partitioning <- csv_melt_formatter("results/R_partitioning_wheat.csv","Wheat")
#partitioning
partitioning_plot <- area_plotter(partitioning[[1]],partitioning[[2]])
partitioning_plot
```
Julian
